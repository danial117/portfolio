...
function Contact() {
    ...
    const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (formRef.current) {
            emailjs.sendForm('service_rnhi24i', 'template_i7aazh5', formRef.current, 'sawQWSAG7uz3i7Ew7').then(
                (result) => {
                    console.log(result.text);
                    toast.success('Email sent successfully!', { className: 'toast-success' });
                    setSuccess(true);
                    setError(null);
                ...
                (error) => {
                    ...
                    toast.error('Error sending email.', { className: 'toast-error' });
                    setSuccess(false);
        ...
        <motion.div ref={ref} className={"contact"} variants={variants} initial={"initial"} whileInView={"animate"}>
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div className="item" variants={variants}>
                    ...
                    <motion.a href="mailto:muneebhaider564@gmail.com">muneebhaider564@gmail.com</motion.a>

                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Address</h2>
                    {/*<span>54/7 Block A Satellite Town</span>*/}
                    <p>54/7 Block A Satellite Town</p>
            ...
            <motion.div className="formContainer" >
                ...
                >
                    <svg width="650px" height="470px" viewBox="0 0 24 24" fill="none"
